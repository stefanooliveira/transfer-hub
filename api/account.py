...
class Account:
    ...
    def transfer(self, destination: 'Account', amount: int):
        ...
        if amount < 0:
            logger.error(f"Invalid transfer amount: {amount} from account {self._account_id} to {destination.account_id}. Transfer amount must be positive")
